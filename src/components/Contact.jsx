  ...
  return (
    ...
    >
      ...
      <p className="text-center text-gray-400 max-w-xl mx-auto z-10 relative">
        "I'm always open to new opportunities, exciting projects, or simply a good conversation. Let's connect and create something amazing together."
      </p>
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="mt-10 space-y-4">
            ...
            <ul className="text-sm space-y-4 text-gray-300">
              ...
              <li>
                <a href="mailto:karan.chittora@gmail.com" className="hover:text-teal-400">
                  <Mail size={14} className="inline mr-1" />
                  Send Email
                </a>
              </li>
              <li>
                <a href="https://linkedin.com/in/krnchittora" target="_blank" className="hover:text-teal-400" rel="noopener noreferrer">
                  <Linkedin size={14} className="inline mr-1" />
                  LinkedIn Profile
                </a>
              </li>
              <li>
                <a href="https://github.com/krnchittora" target="_blank" className="hover:text-teal-400" rel="noopener noreferrer">
        ...
        {/* Contact Form */}
        <form action="https://formsubmit.co/karan.chittora@gmail.com" method="POST" className="space-y-4">
          ...
          <textarea name="message" rows="5" placeholder="Your Message" required className="w-full p-3 rounded bg-gray-800 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-teal-500" />
